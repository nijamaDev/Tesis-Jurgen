\begin{spacing}{1.5}
  ...
  Se prepararon y realizaron dos pruebas para medir la eficiencia de los sistemas implementados.
      ...
      \begin{table}[h]
            ...
            \hline
            \textbf{n} & \textbf{Procesador por Nodo} & \textbf{Nodos} & \textbf{Núcleos por Nodo} & \textbf{Time(s)} \\
            \hline
            Fila 1 & Valor 1 & Valor 2 & Valor 3 \\
            \hline
            Fila 2 & Valor 1 & Valor 2 & Valor 3 \\
            \hline
            Fila 3 & Valor 1 & Valor 2 & Valor 3 \\
            \hline
            \end{tabular}
